...
# -*- coding: utf-8 -*-
"""
Batch experiment for 20 random 4-position combinations.
...
def generate_random_position_combinations(
    ...
    all_combinations = list(generate_position_combinations(n, k))
...
def run_batch_experiment() -> str:
    ...
    zero_ber_results_file = os.path.join(project_root, "test-4", ZERO_BER_RESULTS_FILENAME)
    ...
    with open(results_file, "a", newline="", encoding="utf-8-sig") as f, open(
        ...
        for idx, combination in enumerate(combinations, start=1):
            ...
            while True:
                ...
                print(
                    f"  best BER so far {best_result['best_ber']:.6f} is above "
