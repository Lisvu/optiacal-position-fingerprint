...
# -*- coding: utf-8 -*-
"""
Security-aware probe and hue-mapping search for 2 legal positions on yellow_shuffled dataset.

Target: legal BER ≈ 0, min illegal BER > 0.3
"""
...
OUTPUT_RESULTS_FILENAME = "yellow_shuffled_safe_probes_2.csv"
...
def load_test_module() -> types.ModuleType:
    module_name = "test_3_simple_runtime_yellow_shuffled_2"
